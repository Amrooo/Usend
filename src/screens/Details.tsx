  ...
  return (
    <div className="relative w-full">
      <div className="flex items-center">
        ...
        />
        {isLoading && <div className={`w-3 h-3 border-2 border-emerald-500 border-t-transparent rounded-full animate-spin ${isRTL ? 'mr-2' : 'ml-2'}`}></div>}
      </div>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-6 space-y-8 pb-32 pt-4 relative z-10">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-500 text-[12px] font-bold tracking-wider uppercase flex items-center gap-1">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-4 shadow-sm border border-zinc-100 dark:border-zinc-800 transition-colors duration-300">
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                {isListening && (
                  <span className="text-[12px] font-bold text-emerald-500 animate-pulse uppercase tracking-wider flex items-center gap-1">
              ...
              <div className="relative">
                <textarea 
                  ...
                  className={`w-full h-24 bg-zinc-50 dark:bg-zinc-950/50 rounded-2xl p-4 pr-12 text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none border transition-all duration-300 text-left rtl:text-right ${micError ? 'border-red-500' : isListening ? 'border-emerald-500 ring-2 ring-green-500/10' : 'border-zinc-200 dark:border-zinc-800'}`}
                ></textarea>
                <button
              ...
              <div className="flex gap-3">
                <div className="flex-1 relative">
                  <input 
                    ...
                    className="w-full h-12 bg-zinc-50 dark:bg-zinc-950/50 rounded-xl px-4 pr-8 text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 border border-zinc-200 dark:border-zinc-800 transition-colors duration-300 text-left rtl:text-right" 
                  />
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {weight && (
                  <span className="px-3 py-1.5 rounded-full border border-emerald-500/30 text-emerald-700 dark:text-emerald-400 text-xs font-semibold bg-emerald-500/5 flex items-center gap-1.5 transition-colors duration-300">
        ...
        <section>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-5 shadow-sm border border-zinc-100 dark:border-zinc-800 relative transition-colors duration-300">
            ...
            <div className="flex gap-4 mb-6 relative z-10">
              <div className="w-6 h-6 rounded-full border-[3px] border-emerald-500 bg-white dark:bg-zinc-900 flex-shrink-0 mt-1 transition-colors duration-300"></div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-xs font-bold text-emerald-600 dark:text-emerald-500 tracking-wider uppercase">{t('asap')}</button>
          </div>
            ...
            {[
              ...
              <button 
                ...
                className={`flex-shrink-0 w-20 py-4 rounded-2xl flex flex-col items-center gap-1 transition-all duration-300 active:scale-95 ${
                  d.active 
                    ? 'bg-emerald-700 text-white shadow-lg shadow-green-700/30 dark:shadow-none' 
                    : 'bg-white dark:bg-zinc-900 text-zinc-400 dark:text-zinc-500 border border-zinc-100 dark:border-zinc-800'
                }`}
              >
                <span className={`text-[12px] font-bold tracking-widest uppercase ${d.active ? 'text-emerald-200' : ''}`}>{d.day}</span>
                <span className={`text-2xl font-black ${d.active ? 'text-white' : 'text-zinc-900 dark:text-zinc-100'}`}>{d.date}</span>
                <span className={`text-[12px] font-bold tracking-widest uppercase ${d.active ? 'text-emerald-200' : ''}`}>{d.month}</span>
              </button>
            ))}
          </div>
            ...
            <div className="overflow-y-auto p-6 space-y-4">
              {savedAddresses.map((addr) => (
                <button
                  ...
                  className="w-full flex items-center gap-4 p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 hover:border-emerald-500 dark:hover:border-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/10 transition-colors text-left rtl:text-right"
                >
