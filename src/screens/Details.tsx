      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-6 space-y-8 pb-32 pt-4 relative z-10">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-2.5 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-500 text-[10px] font-bold tracking-wider uppercase flex items-center gap-1">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-4 shadow-sm border border-zinc-100 dark:border-zinc-800 transition-colors duration-300">
            ...
            <div className="mt-6">
              <p className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-zinc-500 uppercase mb-3 text-left rtl:text-right">{t('package_type')}</p>
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between mb-2">
                <p className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-zinc-500 uppercase text-left rtl:text-right">{t('describe_manually')}</p>
                {isListening && (
                  <span className="text-[10px] font-bold text-blue-500 animate-pulse uppercase tracking-wider flex items-center gap-1">
              ...
              {micError && (
                <p className="mt-2 text-[10px] font-bold text-red-500 uppercase tracking-widest animate-pulse">
                  {micError}
                </p>
              )}
            </div>
            ...
            <div className="mt-4">
              <p className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-zinc-500 uppercase mb-2 text-left rtl:text-right">{t('dimensions')}</p>
              <div className="flex gap-3">
                <div className="flex-1 relative">
                  ...
                  />
                  <span className={`absolute ${isRTL ? 'left-3' : 'right-3'} top-1/2 -translate-y-1/2 text-[10px] text-zinc-400 font-medium`}>cm</span>
                </div>
                <div className="flex-1 relative">
                  <input 
                    type="number" 
            ...
            <div className="mt-4">
              <p className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-zinc-500 uppercase mb-2 text-left rtl:text-right">{t('weight')}</p>
              <div className="relative">
                <input 
                  type="number" 
                  placeholder="0.0" 
                  ...
                  className="w-full h-12 bg-zinc-50 dark:bg-zinc-950/50 rounded-xl px-4 pr-8 text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 border border-zinc-200 dark:border-zinc-800 transition-colors duration-300 text-left rtl:text-right" 
                />
                <span className={`absolute ${isRTL ? 'left-3' : 'right-3'} top-1/2 -translate-y-1/2 text-[10px] text-zinc-400 font-medium`}>kg</span>
              </div>
            </div>

            <div className="mt-4">
              <p className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-zinc-500 uppercase mb-2 text-left rtl:text-right">{t('ai_suggested')}</p>
        ...
        <section>
          ...
          <div className="flex gap-3 overflow-x-auto hide-scrollbar pb-2 -mx-6 px-6">
            {[
              ...
              >
                <span className={`text-[10px] font-bold tracking-widest uppercase ${d.active ? 'text-blue-200' : ''}`}>{d.day}</span>
                <span className={`text-2xl font-black ${d.active ? 'text-white' : 'text-zinc-900 dark:text-zinc-100'}`}>{d.date}</span>
                <span className={`text-[10px] font-bold tracking-widest uppercase ${d.active ? 'text-blue-200' : ''}`}>{d.month}</span>
              </button>
            ))}
          </div>
          ...
          <div className="mt-4 bg-white dark:bg-zinc-900 rounded-2xl p-4 flex items-center justify-between border border-zinc-100 dark:border-zinc-800 shadow-sm transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left rtl:text-right">
                <p className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-zinc-500 uppercase">{t('pickup_window')}</p>
