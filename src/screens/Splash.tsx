    ...
    >
      ...
      >
        <button
          ...
          className="w-full h-16 bg-[#3a4a2c] rounded-3xl flex items-center justify-center gap-2 text-white font-semibold text-lg shadow-[0_8px_30px_rgb(21,128,61,0.4)] dark:shadow-none transition-transform active:scale-95"
        >
          {t('get_started')}
