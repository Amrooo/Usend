...
const Login: React.FC<LoginProps> = ({ onNavigate }) => {
  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] text-[#111111] font-sans overflow-x-hidden relative flex flex-col ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      {/* Top Banner Accent */}
      <div className="absolute top-0 inset-x-0 h-1.5 bg-[#1452D1] z-[110]" />
      ...
      <div className="relative p-4 md:p-6 lg:p-8 w-full max-w-[1600px] mx-auto flex-1 flex flex-col">
        ...
        <main className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 mt-32 md:mt-0">
          <div className="w-full max-w-md my-auto bg-white p-8 lg:p-10 rounded-[2.5rem] shadow-sm border border-zinc-200/80 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-32 h-32 rounded-full blur-[80px] opacity-20 bg-[#1452D1]/20 pointer-events-none" />
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <button
                      ...
                      className="group relative p-4 rounded-[1.8rem] bg-white border border-zinc-200/80 hover:border-[#1452D1]/40 text-left transition-all duration-300 shadow-sm flex items-center justify-between active:scale-[0.99]"
                    >
                      <div className={`flex items-center gap-4 ${isRTL ? 'flex-row-reverse text-right' : ''}`}>
                        <div className="w-12 h-12 rounded-xl bg-zinc-50 group-hover:bg-[#1452D1]/5 flex items-center justify-center transition-colors shadow-sm border border-zinc-150">
                          <User className="w-5 h-5 text-zinc-500 group-hover:text-[#1452D1] transition-colors" />
                        </div>
                        <div>
                    ...
                    >
                      <div className={`flex items-center gap-4 ${isRTL ? 'flex-row-reverse text-right' : ''}`}>
                        <div className="w-12 h-12 rounded-xl bg-zinc-50 group-hover:bg-[#1452D1]/5 flex items-center justify-center transition-colors shadow-sm border border-zinc-150">
                          <Building2 className="w-5 h-5 text-zinc-500 group-hover:text-[#1452D1] transition-colors" />
                        </div>
                        <div>
                ...
                >
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className={`w-full h-12.5 bg-zinc-50/50 border border-zinc-200/80 focus:border-[#1452D1] focus:bg-white outline-none rounded-xl ${isRTL ? 'pr-11 pl-4 text-right' : 'pl-11 pr-4'} text-zinc-900 placeholder:text-zinc-400 transition-all text-sm font-semibold`}
                  ...
                  <p className="text-center text-zinc-400 text-[12px] font-semibold uppercase tracking-wider pt-2">
                    ...
                    <button
                      ...
                      className="text-[#1452D1] hover:underline hover:text-blue-600 font-extrabold ml-1"
                    >
