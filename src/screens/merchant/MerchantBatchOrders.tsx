          ...
          {!isFreightMode && !isFreightQuoteMode ? (
              ...
              <div className="bg-white rounded-[2rem] p-8 border border-zinc-200/80 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                  ...
                  <button 
                    ...
                    className="flex-1 md:flex-none bg-emerald-600 hover:bg-emerald-500 text-white font-bold px-5 py-3 rounded-xl text-xs uppercase tracking-wider transition-all whitespace-nowrap"
                  >
                    Select File & Import
                  </button>
                  <input 
              ...
              <div className="bg-white rounded-[2rem] border border-zinc-200 shadow-sm overflow-hidden">
                        ...
                        <tr key={order.id} className="hover:bg-zinc-50/20 group">
                          <td className="p-3 pl-6">
                            <input 
                              ...
                              className={`w-full bg-transparent px-3 py-2 border rounded-lg text-xs outline-none ${
                                errors[order.id]?.customer ? 'border-red-500 bg-red-50/30' : 'border-zinc-200 focus:border-emerald-500'
                              }`}
                            />
                          </td>
                          <td className="p-3">
                            <input 
                              ...
                              className={`w-full bg-transparent px-3 py-2 border rounded-lg text-xs outline-none font-mono tracking-widest ${errors[order.id]?.phone ? 'border-red-500 bg-red-50/30' : 'border-zinc-200 focus:border-emerald-500'}`}
                              dir="ltr"
                            />
                          ...
                          <td className="p-3">
                            <input 
                              ...
                              className={`w-full bg-transparent px-3 py-2 border rounded-lg text-xs outline-none ${
                                errors[order.id]?.address ? 'border-red-500 bg-red-50/30' : 'border-zinc-200 focus:border-emerald-500'
                              }`}
                            />
                          </td>
                          <td className="p-3">
                            <input 
                              ...
                              placeholder="120.00"
                              className={`w-full bg-transparent px-3 py-2 border rounded-lg text-xs outline-none ${
                                errors[order.id]?.amount ? 'border-red-500 bg-red-50/30' : 'border-zinc-200 focus:border-emerald-500'
                              }`}
                            />
                          </td>
                          <td className="p-3">
                            <select 
                              ...
                              className="bg-transparent px-3 py-2 border border-zinc-200 rounded-lg text-xs outline-none focus:border-emerald-500 font-bold"
                            >
                ...
                <div className="p-8 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-4 bg-zinc-50/30">
                  ...
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold h-12 px-8 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg active:scale-95 flex items-center gap-2 disabled:opacity-50"
                  >
                    {isSubmittingCSV ? (
                ...
                <div className="bg-white border border-zinc-200 rounded-[2.5rem] p-8 shadow-md flex flex-col justify-between">
                    ...
                    {!freightQuoteResponse ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2.5 text-xs text-zinc-500 font-bold border-t border-zinc-100 pt-4">
                          ...
                          <div className="flex justify-between text-emerald-600 font-black border-t border-zinc-50 pt-3">
                  ...
                  {freightQuoteResponse && (
                    <button
                      ...
                      className="w-full mt-8 py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20"
                    >
            ...
            <div className="max-w-3xl mx-auto bg-white p-10 rounded-[2.5rem] border border-zinc-200/80 shadow-md text-left space-y-6">
              <div className="flex items-center gap-4 text-left border-b border-zinc-100 pb-5">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-700 to-emerald-500 text-white flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button 
                  ...
                  className={`p-5 rounded-2xl border-2 text-left transition-all ${freightData.containerSize === '20gp' ? 'border-emerald-500 bg-emerald-50/10' : 'border-zinc-200'}`}
                >
                ...
                <button 
                  ...
                  className={`p-5 rounded-2xl border-2 text-left transition-all ${freightData.containerSize === '40hc' ? 'border-emerald-500 bg-emerald-50/10' : 'border-zinc-200'}`}
                >
              ...
              <div className="space-y-1 text-xs text-zinc-500">
                ...
                <div className="flex justify-between py-2 text-base font-bold text-zinc-800 pt-3">
                  ...
                  <span className="text-emerald-600">AED 920.00</span>
                </div>
              </div>
