  ...
  const TimelinePart: FC<{ dot: ReactNode, title: string, desc: string, active?: boolean, last?: boolean }> = ({ dot, title, desc, active, last }) => (
    <div className="flex gap-4 min-h-[60px]">
       <div className="flex flex-col items-center">
          <div className={`w-8 h-8 rounded-full flex items-center justify-center z-10 ${active ? 'bg-gradient-to-r from-blue-700 to-blue-500 text-white shadow-lg shadow-[#3a4a2c]/30' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-400'}`}>
             {dot}
          </div>
      ...
      <main className="flex-1 p-4 md:p-8 h-full overflow-y-auto relative">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             ...
             <div className="bg-white p-5 rounded-3xl border border-zinc-200 shadow-sm overflow-hidden relative group">
                <div className="flex items-center justify-between mb-2">
                   <div className="w-8 h-8 rounded-xl bg-[#3a4a2c]/10 flex items-center justify-center text-[#3a4a2c]">
                      <Clock className="w-4 h-4" />
                   </div>
                   <span className="text-[12px] font-black text-[#3a4a2c]/60 uppercase tracking-wider">{t('in_transit')}</span>
                </div>
          ...
          <div className="flex flex-col md:flex-row flex-wrap gap-3 mt-4">
             <div className="relative flex-1 min-w-[200px]">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-zinc-200 rounded-xl pl-10 pr-4 py-2.5 outline-none text-zinc-900 text-sm font-medium focus:border-[#3a4a2c] transition-colors"
                />
             </div>
                    ...
                    <div className={`flex flex-col gap-3 ${isRTL ? 'pr-4' : 'pl-4'}`}>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-zinc-200/80">
                        ...
                        <div className="flex items-center gap-1.5 bg-zinc-100 px-2 py-1 rounded-md">
                          <Clock className="w-3 h-3 text-[#3a4a2c]" />
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-hide">
                    ...
                    >
                      <div className="flex flex-col gap-3">
                        <div className="flex items-center justify-between">
                           ...
                           <span className="text-[12px] text-[#3a4a2c] font-extrabold flex items-center gap-1 bg-[#3a4a2c]/10 px-2 py-0.5 rounded-md">
                        ...
                        {liveSelectedOrder.aramexLogs?.pickupId && (
                           <div className="bg-[#3a4a2c]/10 border border-[#3a4a2c]/20 text-[#3a4a2c] p-3 rounded-xl flex items-center justify-between px-4">
                        ...
                        <div className="border border-zinc-200 rounded-2xl overflow-hidden bg-zinc-50">
                          ...
                          >
                            <span className="flex items-center gap-1.5 uppercase font-black">
                              <Terminal className="w-3.5 h-3.5 text-[#3a4a2c]" />
                              SOAP Web Service Traces
                            </span>
                            <span className="text-[13px] font-bold text-[#3a4a2c] bg-[#3a4a2c]/10 px-2 py-0.5 rounded">{showSoapLogs ? 'Hide' : 'WSDL XML'}</span>
                          </button>
                          ...
                          {showSoapLogs && (
                            <div className="p-3 border-t border-zinc-200 space-y-3 font-mono text-[12px] max-h-[220px] overflow-y-auto bg-black text-zinc-300">
                              <div className="space-y-1">
                                <span className="text-[#3a4a2c] font-black block uppercase tracking-wider text-[13px]">WSDL ENDPOINT: https://ws.aramex.net/ShippingAPI.v1</span>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                       <div className="flex items-center gap-2">
                          <div className="w-1.5 h-4 bg-[#3a4a2c] rounded-full" />
                          <h3 className="text-sm font-bold text-zinc-900">{t('current_status')}</h3>
                       </div>
                       <button className="flex items-center gap-1.5 text-xs font-bold text-[#3a4a2c] bg-[#3a4a2c]/5 hover:bg-[#3a4a2c]/10 px-3 py-1.5 rounded-lg transition-colors">
                          <FileText className="w-3.5 h-3.5" />
                          Download AWB
                       </button>
                    </div>
