              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white p-8 rounded-[2.5rem] border border-zinc-200 shadow-sm space-y-4">
                  ...
                  <div className="p-5 border-2 border-dashed border-zinc-250 rounded-2xl flex items-center justify-between">
                    ...
                    <span className="text-[12px] bg-[#113f36]/5 text-[#113f36] font-extrabold uppercase tracking-widest px-2.5 py-1 rounded-full">Primary</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-[2.5rem] border border-zinc-200 p-8 shadow-md text-left flex flex-col h-full justify-between">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2 text-xs text-zinc-500 font-medium">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-[#113f36] font-bold">Instant to AED bank</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {codPending > 0 ? (
                    ...
                    <div className="p-4 bg-[#113f36]/5 text-[#113f36] text-center font-bold text-xs rounded-xl mt-6">
          ...
          >
            {stripeShowReceipt ? (
              <div className="text-center space-y-5 py-2">
                <div className="w-14 h-14 bg-[#113f36]/5 rounded-full flex items-center justify-center mx-auto border border-[#113f36]/10">
                ...
                <div className="bg-zinc-50 rounded-2xl p-4 border border-zinc-100 text-xs space-y-2.5 max-w-sm mx-auto text-left font-medium">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-[#113f36]">Stripe UAE (Secure card)</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="text-center py-10 space-y-4">
                <div className="relative w-12 h-12 mx-auto">
                  ...
                  <div className="absolute inset-0 rounded-full border-4 border-[#113f36] border-t-transparent animate-spin" />
                </div>
                <div className="space-y-1">
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="px-2 py-0.5 rounded-full text-[12px] font-black uppercase bg-[#113f36]/5 text-[#113f36] border border-[#113f36]/10 font-mono">stripe.com</span>
                </div>
                ...
                <div className="space-y-4 text-left">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border flex flex-col items-center gap-1.5 font-bold transition-all cursor-pointer text-center ${
                          stripeMethod !== 'standard'
                            ? 'bg-[#113f36]/5 border-blue-350 text-[#113f36]'
                            : 'bg-zinc-50 hover:bg-zinc-100 text-zinc-600 border-zinc-200'
                        }`}
                      >
                  ...
                  {stripeMethod !== 'standard' && !stripeClientSecret && (
                    <div className="p-4 bg-[#113f36]/5 border border-[#113f36]/10 rounded-2xl text-xs text-[#113f36] font-bold flex items-center justify-between">
                      <span>Stripe secure gateway ready</span>
                      <span className="w-2 h-2 bg-[#113f36] rounded-full animate-pulse" />
                    </div>
                  )}
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    {(stripeMethod === 'standard' || !stripeClientSecret) && (
                      <button
                        ...
                        className="flex-[2] py-3 font-bold bg-[#1a5c4e] hover:bg-[#113f36] text-white rounded-xl shadow-lg transition-all cursor-pointer text-center"
                      >
