                ...
                <div className="bg-white p-6 rounded-3xl border border-zinc-200 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="text" defaultValue="USend Electronic Store" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">{t('phone')}</label>
                      <input type="text" defaultValue="+971 50 123 4567" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900" />
                    </div>
                    <div className="space-y-2 md:col-span-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">{t('address') || 'Business Address'}</label>
                      <input type="text" defaultValue="Dubai Silicon Oasis, UAE" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900" />
                    </div>
                  </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-zinc-200 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <input type="text" defaultValue="Emirates NBD" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900" />
                    </div>
                    <div className="space-y-2 md:col-span-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">{t('account_name') || 'Account Holder Name'}</label>
                      <input type="text" defaultValue="USend Electronic LLC" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900" />
                    </div>
                    <div className="space-y-2 md:col-span-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">{t('iban') || 'IBAN'}</label>
                      <input type="text" defaultValue="AE00 0000 0000 0000 0000 000" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900 font-mono" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">{t('swift_code') || 'SWIFT Code'}</label>
                      <input type="text" defaultValue="EBIZAEAD" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900 font-mono" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-zinc-500">{t('account_number') || 'Account Number'}</label>
                      <input type="text" defaultValue="1010101010" className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-3 outline-none text-zinc-900 font-mono" />
                    </div>
                  </div>
                  <div className="mt-6 flex justify-end">
