                        ...
                        <tr key={idx} className="hover:bg-zinc-50/10">
                          ...
                          <td className="p-4">
                            <span className={`font-bold ${
                              txn.amount > 0 ? 'text-[#113f36]' : 'text-zinc-600'
                            }`}>{txn.type}</span>
                          </td>
                          <td className="p-4 text-zinc-400">{txn.method}</td>
                          <td className={`p-4 text-right pr-6 font-bold font-mono ${txn.amount > 0 ? 'text-[#113f36]' : 'text-zinc-900'}`}>
          ...
          >
            {stripeShowReceipt ? (
              <div className="text-center py-6 space-y-6">
                <div className="w-16 h-16 bg-[#113f36]/10 text-[#113f36] rounded-full flex items-center justify-center mx-auto">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border flex flex-col items-center gap-1.5 font-bold transition-all cursor-pointer text-center ${
                          stripeMethod !== 'standard'
                            ? 'bg-[#113f36]/5 border-blue-300 text-[#113f36]'
                            : 'bg-zinc-50 hover:bg-zinc-100 text-zinc-600 border-zinc-200'
                        }`}
                      >
