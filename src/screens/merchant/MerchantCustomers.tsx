              ...
              >
                ...
                <div className="p-8 space-y-8">
                  ...
                  <div className="flex flex-col items-center text-center">
                    <div className="w-24 h-24 bg-[#113f36]/10 text-[#113f36] rounded-full flex items-center justify-center text-4xl font-black mb-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    <button className="flex-1 bg-[#1a5c4e] hover:bg-[#113f36] text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-blue-600/20 active:scale-95">
                      {t('contact_customer')}
                    </button>
                  </div>
                </div>
