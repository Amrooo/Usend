        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="flex flex-col gap-4 w-full mt-4">
            ...
            <div className="bg-zinc-50 dark:bg-zinc-800/40 p-4 rounded-2xl flex flex-col gap-2.5 text-xs text-left border border-zinc-100 dark:border-zinc-800/80">
              <div className="flex items-center gap-1.5 text-[12px] font-black uppercase text-[#3a4a2c] tracking-wider">
                ...
                className={`px-5 py-2.5 rounded-full text-[12px] font-black uppercase tracking-widest transition-all duration-200 shadow-sm shrink-0 ${
                  isConnecting
                    ...
                    : isConnected
                      ...
                      : 'bg-[#3a4a2c] hover:bg-zinc-950 text-white dark:hover:bg-white dark:hover:text-zinc-950 active:scale-95'
                }`}
              >
                {isConnecting ? (
                  <>
          ...
          {isStripe ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left animate-in fade-in duration-200 font-sans">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div className="bg-[#3a4a2c]/5 dark:bg-blue-950/20 border border-[#3a4a2c]/20/50 p-6 rounded-3xl space-y-3">
                  ...
                  <p className="text-xs text-[#3a4a2c] dark:text-[#8da379] leading-relaxed font-sans font-medium">
                  ...
                  <div className="text-[12px] bg-[#3a4a2c]/10/60 dark:bg-zinc-900/30 p-2.5 rounded-xl border border-[#3a4a2c]/20/30 text-[#3a4a2c] dark:text-[#a5b994] flex items-center gap-2">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] p-6 shadow-sm space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2 py-0.5 rounded-full text-[12px] font-black bg-[#3a4a2c]/5 text-[#3a4a2c] border border-[#3a4a2c]/10 uppercase font-mono tracking-widest">stripe.com</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`px-3 py-1 rounded-full text-[12px] font-black uppercase font-sans tracking-wide border ${
                      stripeIsChecking 
                        ...
                        : stripeIsConnected
                        ? 'bg-[#3a4a2c]/5 text-[#3a4a2c] border-[#3a4a2c]/10 dark:bg-blue-950/20 dark:border-blue-990/30'
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <form onSubmit={handleSaveWebhook} className="bg-white p-8 rounded-[2.5rem] border border-zinc-200/80 shadow-sm md:col-span-2 space-y-6">
                  <div className="flex items-center gap-3">
                    <BellRing className="w-5 h-5 text-[#3a4a2c] animate-pulse" />
                ...
                <div className="bg-white p-8 rounded-[2.5rem] border border-zinc-200 shadow-sm space-y-6">
                  <div className="flex items-center gap-2">
                    <Cpu className="w-5 h-5 text-[#3a4a2c]" />
                  ...
                  <div className="space-y-2.5 font-mono text-[12px] divide-y divide-zinc-100 dark:divide-zinc-800">
                    {webhookLogs.map((log, lIdx) => (
                      <div key={lIdx} className="pt-2 first:pt-0">
                        <span className="text-[#3a4a2c] font-bold block">✓ {log.status} OK • {log.time}</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-5 text-left">
                      ...
                      <button
                        ...
                        className="w-full py-4 bg-[#3a4a2c] hover:bg-zinc-950 text-white dark:hover:bg-white dark:text-zinc-950 dark:hover:text-[#3a4a2c] font-black text-xs uppercase tracking-widest rounded-2xl transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 active:scale-98"
                      >
                        {platformConnecting ? (
                          <>
                    ...
                    <div className="bg-zinc-950 text-zinc-400 rounded-3xl p-6 md:p-8 font-mono text-[12px] flex flex-col justify-between border border-zinc-850 h-[360px] relative">
                      <div className="absolute top-4 right-4 text-[12px] uppercase tracking-widest text-[#3a4a2c] font-bold">API Synchronization</div>
                      ...
                      >
                        <div className="space-y-4">
                          <div className="flex justify-between items-start">
                            ...
                            {isConnected ? (
                              <div className="flex items-center gap-1.5 text-[12px] font-black text-[#3a4a2c] dark:text-[#6d8c55] bg-[#3a4a2c]/10 px-3 py-1.5 rounded-full uppercase tracking-wider">
                          ...
                          {isConnected ? (
                            ...
                            <>
                              <button 
                                ...
                                className="px-5 py-2.5 rounded-full font-black text-[12px] uppercase tracking-widest bg-[#3a4a2c] hover:bg-zinc-950 text-white dark:hover:bg-white dark:text-zinc-950 transition-all shadow-sm active:scale-95 cursor-pointer w-full sm:w-auto text-center"
                              >
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-sm overflow-hidden flex flex-col">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 p-8 bg-white dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800">
                  <div className="w-14 h-14 rounded-2xl bg-[#3a4a2c]/10 text-[#3a4a2c] flex items-center justify-center shrink-0">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-800/20 px-8 py-5 border-b border-zinc-100 dark:border-zinc-800 flex justify-center">
                  <div className="relative w-full">
                    ...
                    <input 
                      ...
                      className="w-full bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white font-sans text-xs font-semibold rounded-2xl pl-10 pr-4 py-3 border border-zinc-200 dark:border-zinc-700 outline-none focus:ring-2 focus:ring-[#3a4a2c]/20 focus:border-[#3a4a2c] transition-all placeholder:text-zinc-455 placeholder:font-normal" 
                    />
                  </div>
                </div>
                ...
                <div className="p-8 bg-zinc-50/50 dark:bg-zinc-950/20 flex-1 min-h-[350px]">
                  {filteredCouriers.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
                      <div className="w-16 h-16 rounded-full bg-[#3a4a2c]/5 dark:bg-zinc-800 flex items-center justify-center text-[#5195ca] mb-4">
              ...
              >
                ...
                <div className="p-8 bg-zinc-950 text-white flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-800 shrink-0">
                  <div className="flex items-center gap-4 text-left">
                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-[#3a4a2c]">
                  ...
                  <div className="flex items-center gap-3 bg-white/5 border border-white/10 py-2.5 px-4 rounded-xl text-left font-mono text-[12px] self-start md:self-auto">
                    <div className="w-2.5 h-2.5 bg-[#3a4a2c] rounded-full animate-ping"></div>
                    <div>
                ...
                <div className="p-8 overflow-y-auto flex-1 bg-zinc-50/30 dark:bg-[#0c0c0e]">
                  ...
                  {sandboxActiveTab === 'config' && (
                    <div className="space-y-6 text-left animate-in fade-in duration-200">
                      <div className="p-4 bg-[#3a4a2c]/5 dark:bg-blue-950/25 border border-[#3a4a2c]/20/40 rounded-2xl flex items-start gap-3">
                        <Info className="w-5 h-5 text-[#3a4a2c] shrink-0 mt-0.5" />
                        <div>
                          <p className="text-xs font-bold text-[#3a4a2c] dark:text-[#a5b994]">Interactive Sandbox Credentials Connected</p>
                          <p className="text-[13px] text-[#3a4a2c]/80 dark:text-[#8da379]/80 mt-1 leading-relaxed">
                      ...
                      <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800 flex justify-between gap-4">
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-[#3a4a2c] text-white font-black text-xs uppercase tracking-widest rounded-xl hover:bg-zinc-950 dark:hover:bg-white dark:hover:text-zinc-950 transition-colors shadow-lg shadow-[#3a4a2c]/10"
                        >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 space-y-4">
                          <h4 className="font-bold text-xs uppercase tracking-widest text-zinc-850 dark:text-white flex items-center gap-1.5">
                            <Sliders className="w-4 h-4 text-[#3a4a2c]" /> Parameter Tuner
                          </h4>
                          ...
                          <div className="space-y-1.5">
                            ...
                            <input 
                              ...
                              className="w-full h-1 bg-zinc-200 rounded-lg appearance-none cursor-pointer accent-[#3a4a2c]"
                            />
                          </div>
                          ...
                          <label className="flex items-center gap-2 cursor-pointer pt-2">
                            <input 
                              ...
                              className="w-4 h-4 accent-[#3a4a2c] rounded"
                            />
                          ...
                          <button
                            ...
                            className="w-full py-3 bg-[#3a4a2c] hover:bg-zinc-950 text-white dark:hover:bg-white dark:hover:text-zinc-950 font-black text-[12px] uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-[#3a4a2c]/10"
                          >
                          ...
                          <div className="bg-zinc-950 text-zinc-300 rounded-3xl p-6 font-mono text-[13px] h-[340px] flex flex-col justify-between overflow-hidden shadow-2xl relative">
                            ...
                            {!rateResult && !rateLoading ? (
                              ...
                              <div className="h-full flex flex-col items-center justify-center text-zinc-400 text-center space-y-3">
                                <RefreshCw className="w-8 h-8 animate-spin text-[#3a4a2c]" />
                              ...
                              <div className="flex-1 flex flex-col h-full">
                                <div className="flex justify-between border-b border-zinc-800 pb-3 mb-3 text-[12px] font-bold text-zinc-400 shrink-0">
                                  ...
                                  <span className="text-[#3a4a2c] font-mono">{rateResult.serviceName}</span>
                                </div>
                                ...
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto pr-1 select-all h-full max-h-[190px]">
                                  ...
                                  <div className="text-left bg-zinc-900 border border-zinc-800 rounded-xl p-3 flex flex-col">
                                    <div className="text-[13px] font-black text-[#3a4a2c] uppercase mb-1 flex items-center justify-between">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 space-y-4">
                          <h4 className="font-bold text-xs uppercase tracking-widest text-zinc-850 dark:text-white flex items-center gap-1.5 border-b border-zinc-100 dark:border-zinc-800 pb-2">
                            <Sliders className="w-4 h-4 text-[#3a4a2c]" /> Waybill Information
                          </h4>
                          ...
                          <button
                            ...
                            className="w-full py-3 bg-[#3a4a2c] hover:bg-zinc-950 text-white dark:hover:bg-white dark:hover:text-zinc-950 font-black text-[12px] uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-lg"
                          >
                        ...
                        <div className="lg:col-span-2 space-y-4">
                          {!shipResult && !shipLoading ? (
                            ...
                            <div className="bg-black text-zinc-400 rounded-3xl p-10 h-[430px] flex flex-col items-center justify-center text-center space-y-4 font-mono text-[12px]">
                              <RefreshCw className="w-10 h-10 animate-spin text-[#3a4a2c]" />
                              <div className="space-y-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="bg-zinc-950 text-zinc-300 rounded-3xl p-5 font-mono text-[13px] h-[430px] flex flex-col justify-between overflow-hidden shadow-2xl relative">
                                <div className="absolute top-4 right-4 text-[12px] font-black uppercase text-[#3a4a2c]">SOAP WSDL Trace</div>
                  ...
                  {sandboxActiveTab === 'track' && (
                    <div className="space-y-6 text-left animate-in fade-in duration-200">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 space-y-4">
                          <h4 className="font-bold text-xs uppercase tracking-widest text-[#3a4a2c] flex items-center gap-1.5 border-b border-zinc-100 dark:border-zinc-850 pb-2">
                            <Sliders className="w-4 h-4 text-[#3a4a2c]" /> Tracking Service
                          </h4>
                          ...
                          <button
                            ...
                            className="w-full py-3 bg-[#3a4a2c] hover:bg-zinc-950 text-white dark:hover:bg-white dark:hover:text-zinc-950 font-black text-[12px] uppercase tracking-widest rounded-xl transition-all"
                          >
                              ...
                              <div className="md:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 rounded-[2rem] h-[345px] overflow-y-auto space-y-5 text-left">
                                {trackResult.success === false ? (
                                  ...
                                  <>
                                    ...
                                    <div className="relative border-l-2 border-[#3a4a2c]/30 ml-3 space-y-6">
                                      {trackResult.steps.map((step: any, sIdx: number) => (
                                        <div key={sIdx} className="relative pl-6">
                                          ...
                                          <div className={`absolute -left-[7px] top-1 w-3 h-3 rounded-full border-2 ${
                                            sIdx === trackResult.steps.length - 1 ? 'bg-[#3a4a2c] border-[#3a4a2c]/20 scale-125' : 'bg-[#3a4a2c] border-white dark:border-zinc-900'
                                          }`}></div>
                                          <div className="text-left">
                                            <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[12px] font-black tracking-widest text-[#3a4a2c] uppercase mt-1 block bg-[#3a4a2c]/5 dark:bg-zinc-800 inline-block px-1.5 py-0.5 rounded">{step.status}</span>
                                          </div>
                                        </div>
                                      ))}
                                    </div>
