          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-5">
            ...
            <div className="flex gap-2 self-start sm:self-center">
              ...
              <button 
                ...
                className="bg-[#4d623b] hover:bg-[#3a4a2c] text-white font-bold px-4 py-2 rounded-xl text-xs uppercase tracking-wider transition-all"
              >
                Add Product
              </button>
            </div>
                          ...
                          <td className="p-4">
                            <div className="flex items-center gap-2">
                               ...
                               <span className={`px-2.5 py-1 rounded-full text-[13px] font-black uppercase tracking-widest ${
                                  item.status === 'In Stock' ? 'bg-[#3a4a2c]/5 text-[#3a4a2c]' :
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
                  ...
                  <div className="space-y-2">
                    {replenishLogs.map((log) => (
                      <div key={log.id} className="p-4 border border-zinc-100 rounded-2xl flex items-center justify-between bg-zinc-50/40 hover:bg-zinc-50">
                        ...
                        <span className={`px-2.5 py-1 rounded-full text-[13px] font-black uppercase tracking-widest ${
                          log.status === 'Completed' ? 'bg-[#3a4a2c]/5 text-[#3a4a2c]' : 'bg-[#3a4a2c]/5 text-[#3a4a2c] animate-pulse'
                        }`}>
                          {log.status}
                        </span>
                      </div>
              ...
              <div className="space-y-6">
                <form onSubmit={handleReplenishStock} className="bg-white rounded-[2.5rem] p-8 border border-zinc-200 shadow-md space-y-6">
                  <div className="flex items-center gap-3">
                    <RefreshCw className="w-5 h-5 text-[#3a4a2c]" />
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="Dubai Airport Freezone">Dafza Ground Logistics Depot</option>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className={`relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden ${isRTL ? 'text-right' : 'text-left'} flex flex-col max-h-[85vh]`}
          >
            <div className="p-6 md:p-8 flex-1 overflow-y-auto">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-black text-zinc-900">{t('add_product') || 'Add New Product'}</h2>
                <button
              ...
              <div className="space-y-5">
                 <div className="flex flex-col md:flex-row gap-5">
                    <div className="flex-1">
                       ...
                       <input 
                         ...
                         className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#3a4a2c] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors"
                       />
                    </div>
                    ...
                    <div className="w-full md:w-1/3">
                       ...
                       <select 
                         ...
                         className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#3a4a2c] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors appearance-none"
                       >
                 ...
                 <div>
                    ...
                    <textarea 
                      ...
                      rows={3}
                      className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#3a4a2c] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors resize-none"
                    />
                 </div>
                 ...
                 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                       ...
                       <input 
                         ...
                         placeholder="0.00"
                         className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#3a4a2c] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors font-mono"
                       />
                    </div>
                    <div>
                 ...
                 <div>
                    ...
                    <div className="flex items-center gap-4">
                      <div 
                        ...
                        className={`w-24 h-24 rounded-2xl flex-shrink-0 flex flex-col justify-center items-center cursor-pointer overflow-hidden border-2 border-dashed ${newProduct.image ? 'border-transparent' : 'border-zinc-300 hover:border-[#3a4a2c]'} bg-zinc-50 transition-colors`}
                      >
                        {newProduct.image ? (
              ...
              <div className="mt-8 flex gap-3 pt-6 border-t border-zinc-200">
                ...
                <button 
                  ...
                  className="flex-[2] py-4 bg-gradient-to-r from-blue-700 to-blue-500 hover:from-blue-600 hover:to-blue-400 text-white rounded-2xl font-bold shadow-lg shadow-[#3a4a2c]/20 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Save Product
                </button>
              </div>
