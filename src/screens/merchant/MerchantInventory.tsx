          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-5">
            ...
            <div className="flex gap-2 self-start sm:self-center">
              ...
              <button 
                ...
                className="bg-[#1a5c4e] hover:bg-[#113f36] text-white font-bold px-4 py-2 rounded-xl text-xs uppercase tracking-wider transition-all"
              >
                Add Product
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
              ...
              <div className="space-y-6">
                <form onSubmit={handleReplenishStock} className="bg-white rounded-[2.5rem] p-8 border border-zinc-200 shadow-md space-y-6">
                  <div className="flex items-center gap-3">
                    <RefreshCw className="w-5 h-5 text-[#113f36]" />
            ...
            <div className="p-6 md:p-8 flex-1 overflow-y-auto">
              ...
              <div className="space-y-5">
                 <div className="flex flex-col md:flex-row gap-5">
                    <div className="flex-1">
                       ...
                       <input 
                         ...
                         className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#113f36] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors"
                       />
                    </div>
                    ...
                    <div className="w-full md:w-1/3">
                       ...
                       <select 
                         ...
                         className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#113f36] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors appearance-none"
                       >
                 ...
                 <div>
                    ...
                    <textarea 
                      ...
                      rows={3}
                      className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#113f36] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors resize-none"
                    />
                 </div>
                 ...
                 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                       ...
                       <input 
                         ...
                         placeholder="0.00"
                         className="w-full bg-zinc-50 border-2 border-transparent focus:border-[#113f36] rounded-xl px-4 py-3 outline-none text-zinc-900 transition-colors font-mono"
                       />
                    </div>
                    <div>
                 ...
                 <div>
                    ...
                    <div className="flex items-center gap-4">
                      <div 
                        ...
                        className={`w-24 h-24 rounded-2xl flex-shrink-0 flex flex-col justify-center items-center cursor-pointer overflow-hidden border-2 border-dashed ${newProduct.image ? 'border-transparent' : 'border-zinc-300 hover:border-[#113f36]'} bg-zinc-50 transition-colors`}
                      >
                        {newProduct.image ? (
              ...
              <div className="mt-8 flex gap-3 pt-6 border-t border-zinc-200">
                ...
                <button 
                  ...
                  className="flex-[2] py-4 bg-gradient-to-r from-blue-700 to-blue-500 hover:from-blue-600 hover:to-blue-400 text-white rounded-2xl font-bold shadow-lg shadow-[#113f36]/20 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Save Product
                </button>
              </div>
