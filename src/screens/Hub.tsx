  ...
  const dispatchTerminals = [
    {
      ...
      icon: <User className="w-6 h-6 text-[#047857]" />,
      colorClass: 'from-emerald-500/10 to-emerald-500/10 hover:border-emerald-500/30',
      tagColor: 'bg-emerald-50 text-emerald-800 dark:bg-zinc-900 dark:text-emerald-300',
    ...
    },
    {
      ...
      icon: <Briefcase className="w-6 h-6 text-[#047857]" />,
      colorClass: 'from-emerald-500/10 to-indigo-500/10 hover:border-indigo-500/30',
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <h2 className="text-lg font-black text-zinc-950 flex items-center gap-1 group-hover:text-[#047857] transition-colors duration-300">
                      {terminal.title}
                ...
                <div className="mt-6 pt-4 border-t border-zinc-100/80 flex items-center justify-between">
                  ...
                  <div className="inline-flex items-center gap-1 text-[12px] font-black uppercase tracking-wider text-zinc-400 group-hover:text-[#047857] duration-300">
                    Connect Portal
      ...
      <footer className="bg-white pt-24 pb-16 px-8 border-t border-zinc-100 mt-auto w-full">
         <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
            ...
            <div className="grid grid-cols-2 gap-8 col-span-1 md:col-span-2">
               ...
               <div>
                  ...
                  <ul className="space-y-3 text-zinc-600 text-xs font-bold">
                    <li><a href="#" className="hover:text-[#047857] transition-colors">API Docs</a></li>
                    <li><a href="#" className="hover:text-[#047857] transition-colors">Governance</a></li>
                    <li><a href="#" className="hover:text-[#047857] transition-colors">Careers</a></li>
                  </ul>
               </div>
            </div>
         </div>
         ...
         <div className="max-w-[1400px] mx-auto pt-10 border-t border-zinc-100 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8 text-[13px] font-black text-zinc-400 uppercase tracking-[0.4em]">
               <a href="#" className="hover:text-[#047857] transition-colors">Privacy</a>
               <a href="#" className="hover:text-[#047857] transition-colors">Terms</a>
            </div>
         </div>
      </footer>
