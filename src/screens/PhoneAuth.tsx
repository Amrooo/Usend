            ...
            >
              <div className="flex justify-between gap-3 px-4">
                {otp.map((digit, i) => (
                  <input
                    ...
                    className="w-16 h-20 text-center text-3xl font-black rounded-2xl bg-zinc-50 dark:bg-zinc-900 border-2 border-zinc-100 dark:border-zinc-800 focus:border-blue-600 outline-none transition-all"
                  />
                ))}
              </div>
              ...
              <div className="flex flex-col items-center gap-4">
                <button 
                  ...
                  className="text-xs font-bold text-blue-600 dark:text-blue-500 uppercase tracking-widest disabled:opacity-50"
                >
                  Resend Code
                </button>
