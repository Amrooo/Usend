        ...
        if (item.isFab) {
          return (
            <button 
              ...
              className="w-12 h-12 bg-[#113f36] rounded-full flex items-center justify-center text-white shadow-lg shadow-[#113f36]/30 transform transition-all active:scale-95 hover:bg-gradient-to-r from-blue-700 to-blue-500 flex-shrink-0"
            >
        ...
        return (
          <button
            ...
            className={`relative flex items-center justify-center h-10 px-3 rounded-full transition-all duration-300 ${
              isActive 
                ? 'bg-[#113f36]/5 dark:bg-[#113f36]/10 text-[#113f36] dark:text-[#6d8c55]' 
