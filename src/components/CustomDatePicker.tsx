    ...
    <div className="p-6 space-y-6 max-h-[85vh] overflow-y-auto">
      <div className="flex items-center justify-between">
        <h3 className="font-black text-xl text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
          <CalendarIcon className="w-6 h-6 text-[#113f36]" />
          ...
          return (
            <button
              ...
              className={`h-12 w-full rounded-2xl flex items-center justify-center text-sm font-bold transition-all ${
                isSelected(day)
                  ? 'bg-[#1a5c4e] text-white shadow-lg shadow-[#113f36]/30 ring-2 ring-blue-600 ring-offset-2 dark:ring-offset-zinc-900'
                  : isToday(day)
                    ? 'bg-[#113f36]/5 text-[#113f36] dark:bg-[#113f36]/10'
      ...
      <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800">
        <button
          ...
          className="w-full h-14 bg-[#1a5c4e] hover:bg-[#113f36] text-white rounded-2xl font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-xl shadow-[#113f36]/20"
        >
